...
#Basic models
export EXAMPLESOBJS=queue.o main.o generat.o cpu.o transduc.o constgenerat.o distri.o com.o linpack.o register.o servmt.o dispositivoes.o
...
dispositivoes.o: dispositivoes.cpp
	${CPP} -c ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $<
...
register.o: message.h process.h generat.h cpu.h transduc.h constgenerat.h servmt.h dispositivoes.h
...
servmt.o: servmt.h
dispositivoes.o: dispositivoes.h
